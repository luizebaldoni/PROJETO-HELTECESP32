...
//definições
#define DHTPIN A1 // pino analogico do dht11
#define DHTTYPE DHT11 // DHT 11
#define led 9 // pino digital da led
#define sensor A0 // pino analogico do fotoresistor
#define sensorsinal A2  // pino analogico do sensor de agua

//valores:
int val = 0;  // valor incia em 0
int limiteDisparo = 700;  // valores abaixo de 700 led vai liagr
